...
questionr::freq(
  ...
  kable(caption = "Tabela de frequências para grupo de atendimento", digits = 2, format = "markdown") 
```
...
questionr::freq(
  ...
  kable(caption = "Tabela de frequências para gestante ou puérpera", digits = 2, format = "markdown") 
```
...
questionr::freq(
  ...
  kable(caption = "Tabela de frequências para raça/cor original", digits = 2, format = "markdown") 
```
...
questionr::freq(
  ...
  kable(caption = "Tabela de frequências para raça/cor", digits = 2, format = "markdown") 
```
...
questionr::freq(
  ...
  kable(caption = "Tabela de frequências para UF de aplicação", digits = 2, format = "markdown") 
```
...
questionr::freq(
  ...
  kable(caption = "Tabela de frequências para UF de residência", digits = 2, format = "markdown") 
```
...
questionr::freq(
  ...
  kable(caption = "Tabela de frequências para vacina nome (original)", digits = 2, format = "markdown") 
```
...
questionr::freq(
  ...
  kable(caption = "Tabela de frequências para qual vacina", digits = 2, format = "markdown") 
```
...
questionr::freq(
  ...
  kable(caption = "Tabela de frequências para qual dose", digits = 2, format = "markdown") 
```
...
questionr::freq(
  ...
  kable(caption = "Tabela de frequências para status", digits = 2, format = "markdown") 
```
...
```{r, echo=TRUE, eval= TRUE, message=FALSE, warning =FALSE, error=FALSE}
dados_dup_id <- janitor::get_dupes(dados1, paciente_id, dt_nasc, estabelecimento_valor, vacina_descricao_dose)
dim(dados_dup_id)[1]
...
questionr::freq(
  ...
  kable(caption = "Tabela de frequências para categoria de idade", digits = 2, format = "markdown") 
```
